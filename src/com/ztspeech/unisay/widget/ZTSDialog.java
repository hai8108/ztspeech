...
public class ZTSDialog extends Dialog implements OnClickListener {
	...
	public ZTSDialog(Context context) {
	 ...
	 * 设置对话框的标题
	 */
	public ZTSDialog setTitle(String title) {
	 ...
	 * 设置对话框提示消息
	 */
	public ZTSDialog setMessage(String message) {
	 ...
	 * 设置对话框为输入格式，覆盖提示消息
	 */
	public ZTSDialog setEditMessage(String hint) {
	...
	public ZTSDialog setEditMessageInputType() {
	 ...
	 * 设置输入框长度限制，默认16个字符
	 */
	public ZTSDialog setEditLength(int length) {
	 ...
	 * 重新设置确定和取消按钮监听器
	 */
	public ZTSDialog setButton(TlcyDialogListener okListener, TlcyDialogListener cancelListener) {
	 ...
	 * 设置确定和取消按钮的文本和监听器
	 */
	public ZTSDialog setButton(String oktext, String cancelText, TlcyDialogListener okListener,
	 ...
	 * 设置弹出框为只有一个确定按钮
	 */
	public ZTSDialog setOnlyOkPositiveMethod(String oktext) {
	...
	public void setPositiveMethod(String oktext, String cancelText, TlcyDialogListener okListener,
			TlcyDialogListener cancelListener) {
		bottomLayout02.setVisibility(View.GONE);
		bottomLayout01.setVisibility(View.VISIBLE);
		if (oktext != null && !oktext.trim().equals("")) {
	 ...
	 */
	public ZTSDialog setOnlyOkPositiveMethod(String oktext, TlcyDialogListener okListener) {
		bottomLayout01.setVisibility(View.GONE);
		bottomLayout02.setVisibility(View.VISIBLE);
		if (oktext != null && !oktext.trim().equals("")) {
			if (oktext.equals("1")) {
	...
	public ZTSDialog setItems(String[] datas, OnItemClickListener listener) {
	...
	private class MyAdpter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				v = layoutInflater.inflate(R.layout.tlcydialogitem, null);
				viewHolder.title = (TextView) v.findViewById(R.id.textView);
				v.setTag(viewHolder);
			} else {
				v = convertView;
